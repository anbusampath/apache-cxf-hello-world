package io.anbu.cxf.demo.ws.client;
...
public class SampleWsApplicationClient {
    ...
    public static void main(String[] args) throws Exception {
        String address = "http://localhost:8080/services/helloservice/Hello";
        String request = "<q0:sayHello xmlns:q0=\"http://service.ws.sample/\"><myname>Anbu Sampath</myname></q0:sayHello>";
